    ...
    <el-row class="main" type="flex" justify="center"
      ...
      <el-col :span="20">
        <div style="width: 100%;position: relative;right:90px;top: -10px;"><span style="font-weight: 500;
          ...
          font-size: 16px;
          color: #242629;">{{ mbx == '/about' ? '期货手续费' : '期货保证金' }}</span>>
        </div>
        <el-tabs v-model="activeName" @tab-click="msData">
          <el-tab-pane class="tab_bar_sty" v-for="item in listData" :label="item.title" :name="item.title">
...
font-weight: 500;
color: #545454;
line-height: 14px;">(手续费更新时间: {{ getTodayDate()}}，价格更新时间: {{ getTodayDate()}})</span>
            </div>
