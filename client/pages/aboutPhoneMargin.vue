    ...
    <div class="section_3 flex-col">
      ...
      <div class="group_3 flex-row" style="margin-top: 10px;padding: 10px;">
        ...
        <div class="image-text_1 flex-row justify-between">
          <span class="text-group_1">期货保证金</span>
            ...
            <div>
              <el-table :data="tableData" style="width: 100%">
                ...
                <el-table-column label="手续费(万分之*或*元)">
                  <el-table-column prop="upDown" label="涨/跌停板">
                    <template slot-scope="scope">
                      <span style="color: #FF1B1B">{{ scope.row.upDown.split('/')[0] }}</span>/
                      <span style="color: #5B5BFF">{{ scope.row.upDown.split('/')[1] }}</span>
                    </template>
                  </el-table-column>
                  <el-table-column label="买开" prop="buyOpen">
...
<style scoped lang="css" src="./lanhu_youwenbida/assets/index.rem.css" />@/client/services/index